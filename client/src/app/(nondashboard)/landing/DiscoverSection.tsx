      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 text-center ">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
            ...
            site offers a wide range of rental properties to choose from, so you
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
          {[
            ...
            },
            {
              ...
              description:
                "Once you've found the perfect rental property, book it online and start living your dream life.",
            },
            {
              imageSrc: "/landing-icon-heart.png",
              title: "Enjoy your New Home",
              description:
                "Move into your new home and start living the life you've always dreamed of.",
            },
          ].map((card, index) => (
